...
fc = Firmcorn()
fc.load_context("/home/b1ngo/Firmcorn/dump/UnicornContext_20190309_193002/")
...
fc.hookcode.func_alt(scanf_addr , fc.funcemu.scanf  , 2)
fc.hookcode.func_alt(strcpy_addr , fc.funcemu.strcpy  , 2)
fc.hookcode.func_skip(skip_list)
