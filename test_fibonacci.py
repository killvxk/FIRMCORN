...
instructions_skip_list = [0x00000000004004F6, 0x0000000000400502, 0x000000000040054F]
...
def hook_code(mu, address, size, user_data):  
    ...
    print ("0x%x %s" % (address ,   disasm(instr)) )
